...
<div class="p-6">
    ...
    <p class="font-poppins text-gray-400">Formulir untuk menambahkan akun admin</p>
</div>

<div class="px-6 py-2">
    <div class="bg-white rounded-md border border-gray-100 shadow-black/5 p-6">
        <h1 class="font-semibold text-xl mb-4">Buat Akun Admin</h1>
        <form method="post" action="{{ route('user.store') }}" enctype="multipart/form-data">
            ...
            <fieldset>
                ...
                <label class="block mb-6">
                    ...
                    <input id="password" type="password" required name="password" class="mt-1 px-3 py-2 bg-gray-100 border shadow-sm border-slate-200 placeholder-gray-400 focus:outline-none focus:border-gray-300 focus:ring-gray-300 block w-full rounded-md sm:text-sm focus:ring-1" placeholder="Masukkan Password" />
                </label>
                ...
                <input type="submit" value="Tambah Admin" class="font-bold w-32 h-10 mt-1 px-3 py-2 bg-blue-800 border shadow-sm border-blue-800 block rounded-md sm:text-sm text-white hover:bg-blue-900 hover:text-white">
            </fieldset>
        </form>
    </div>
</div>
